...
#include <ugv_visual_servoing/TagTrajectoryGenerator.h>
...
int main ( int argc, char** argv ) {
    ...
    TagTrajectoryGenerator generator ( "/home/thesidjway/research_ws/src/optimal-visual-servoing/params/ugv_visual_servoing.yaml" );
