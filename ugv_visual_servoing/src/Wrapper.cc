...
#include <ugv_visual_servoing/Wrapper.h>
...
void OVSWrapper::readAllParams(std:: string params_file, std::string aruco_params_file) {
...
int main ( int argc, char **argv ) {
    ros::init ( argc, argv, "ugv_visual_servoing" );
    std::string ovs_params;
    std::string aruco_params;
    OVSWrapper wrapper;
    wrapper.n_.getParam("ovs_params", ovs_params);
    wrapper.n_.getParam("aruco_params", aruco_params);
    wrapper.readAllParams(ovs_params, aruco_params);
