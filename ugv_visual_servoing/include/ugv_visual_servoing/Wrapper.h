...
#include <ugv_visual_servoing/ArucoTagsDetection.h>
#include <ugv_visual_servoing/ClusterExtractor.h>
#include <ugv_visual_servoing/MoveBase.h>
#include <ros/ros.h>
...
public:
    ...
    void readAllParams( std::string params_file, std::string aruco_params_file );
